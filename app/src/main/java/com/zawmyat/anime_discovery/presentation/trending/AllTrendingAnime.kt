...
@Composable
fun AllTrendingAnime(navController: NavHostController) {

    val allTrendingAnimeViewModel : AllTrendingAnimeViewModel = koinViewModel<AllTrendingAnimeViewModel>()
    val trendingAnimes = allTrendingAnimeViewModel.allTrendingAnimes.collectAsLazyPagingItems()
    ...
    Scaffold(
        ...
        Box(
            ...
            if(trendingAnimes.loadState.refresh == LoadState.Loading) {
                ...
                if(isList) {
                    ...
                    LazyColumn(modifier = Modifier.padding(horizontal = 12.dp)) {
                        items(trendingAnimes.itemCount) {
                                index ->
                            trendingAnimes[index]?.let {
                                AnimeListTile(
                                    id = it.id ?: 0,
